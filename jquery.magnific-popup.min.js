 ...
 * Modded to add some functions to wp-manga-reader. Code formatted for better viewing
...
!(function (a) {
    ...
    a.magnificPopup.registerModule("gallery", {
        ...
        proto: {
           ...
           next:function(){
    if (b.index < b.items.length - 1) { // Check if not at the last image
        b.direction=!0;
        b.index=S(b.index+1);
        b.updateItemHTML();
    }
            ...
            prev: function () {
    if (b.index > 0) { // Check if not at the first image
        b.direction = !1;
        b.index = S(b.index - 1);
        b.updateItemHTML();
    }
